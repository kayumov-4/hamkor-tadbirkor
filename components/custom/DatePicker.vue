    ...
    <div>
        ...
        <div class=" px-[16px] border-1 border-[var(--color-grey-border)] mt-3 rounded-xl overflow-hidden flex  items-center gap-[8px] bg-[var(--color-white)]">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M2.91669 7.575H17.0834" stroke="#B9BDC7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M17.5 7.08333V14.1667C17.5 16.6667 16.25 18.3333 13.3333 18.3333H6.66667C3.75 18.3333 2.5 16.6667 2.5 14.1667V7.08333C2.5 4.58333 3.75 2.91666 6.66667 2.91666H13.3333C16.25 2.91666 17.5 4.58333 17.5 7.08333Z" stroke="#B9BDC7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M9.99626 11.4167H10.0037" stroke="#B9BDC7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.91191 11.4167H6.91939" stroke="#B9BDC7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.91191 13.9167H6.91939" stroke="#B9BDC7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
